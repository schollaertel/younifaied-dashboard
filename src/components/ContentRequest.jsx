...
export function ContentRequest() {
  ...
  const [formData, setFormData] = useState({
    // Core fields matching original Typeform and database structure
    email: '',
    name: '',
    topic: '',
    additional_context: '',
    ...
    // Workflow - CRITICAL for triggering
  ...
  const handleAvatarUpload = (e) => {
    ...
    if (file) {
      ...
      setFormData(prev => ({ ...prev, user_avatar: file }));
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Set workflow_status to 'processing' to trigger the workflow
      const requestData = {
        ...formData,
        user_id: user.id,
        ...
        workflow_status: 'processing', // CRITICAL: This triggers the workflow
      ...
      console.log("handleSubmit: Submission successful! Workflow status set to 'processing'");
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed left-0 top-0 h-full w-64 z-40" style={{backgroundColor: '#063e4'}}>
        <div className="p-6">
            ...
            <div className="flex flex-col items-center">
              <div className="relative mb-4">
                ...
                <label 
                  ...
                  className="absolute -bottom-2 -right-2 bg-lime-400 text-white rounded-full w-8 h-8 flex items-center justify-center cursor-pointer hover:bg-lime-500 transition-colors shadow-lg"
                >
          ...
          {/* YouNifAiEd Dashboard Title */}
          <div className="text-white mb-8">
            <h1 className="text-xl font-bold">YouNifAiEd</h1>
          ...
          <nav className="space-y-2">
            ...
            <div className="text-white px-4 py-3 hover:bg-white hover:bg-opacity-10 rounded-lg cursor-pointer transition-colors">
              Content Library
            </div>
            <div className="text-white px-4 py-3 hover:bg-white hover:bg-opacity-10 rounded-lg cursor-pointer transition-colors">
              Analytics
          ...
          {/* Admin Tools */}
          <div className="mt-8">
            <p className="text-white text-xs uppercase tracking-wider opacity-60 mb-4">Admin Tools</p>
          ...
          <div className="px-8 py-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <h2 className="text-2xl font-bold text-white">Content Request</h2>
                <p className="text-sm text-white opacity-80">Create engaging educational content</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  {formData.include_cta && (
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g., Download my free AI prompt templates, Join 500+ teachers using this"
                        className="w-full p-5 border-2 border-gray-200 rounded-2xl focus:ring-3 focus:ring-lime-400 focus:border-lime-400 transition-all duration-300 text-gray-900 placeholder-gray-500 text-lg"
                      />
                    </div>
                  )}
                ...
                <div className="mx-10 mb-10 p-8 bg-gradient-to-r from-lime-50 to-teal-50 text-teal-800 border-2 border-lime-200 rounded-2xl">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-lg">Your content request has been submitted and is being processed. Workflow status set to 'processing' - the automation will begin shortly!</p>
                    </div>
                  </div>
                </div>
              )}
